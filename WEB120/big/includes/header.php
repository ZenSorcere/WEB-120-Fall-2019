...
<main class="wrapper">
<header>
   <h1><a href="Bindex.php"><i class="logo fas fa-jedi"></i>  Mike Gilson's Web Development Examples</a></h1>
  <nav id="cssmenu">
  <ul>
     <li><a href="../index.php"><span><i class="fa fa-fw fa-bank"></i> WEB120 Portal</span></a></li>
     <li><a href="Bindex.php"><span><i class="fa fa-fw fa-home"></i> Home</span></a></li>
