...
<div>	
    <label>
        ...
        <select name="How_Did_You_Hear_About_Us?" required="required" title="How You Heard is required" tabindex="30">
            ...
            <option value="Web">Around the Web</option>
            <option value="Classmate">One of My Classmates</option>
            <option value="A Friend">A Friend</option>
            <option value="Theatre">Theatre Community Gossip</option>
...
<div>	
    <fieldset>
        ...
        <input type="checkbox" name="Interested_In[]" value="Acting" /> My Acting Chops <br />
...
<div>	
    <label>
        Comments:<br /><textarea name="Comments" cols="70" rows="4" placeholder="Tell me what you're looking for!" tabindex="60"></textarea>
    </label>
</div>	
